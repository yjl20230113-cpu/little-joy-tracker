    ...
    >
      <div className="joy-scroll-hidden flex gap-1.5 overflow-x-auto pb-0.5">
        {peopleFilters.map((filter) => (
          <button
            ...
            className={`whitespace-nowrap rounded-full px-3 py-1.5 text-[0.8rem] font-semibold transition-all ${
      ...
      {showSummaryButton ? (
        <button
          ...
          className="inline-flex w-full items-center justify-center gap-1.5 rounded-[0.95rem] bg-[#ffd4e5] px-3.5 py-2 text-[0.8rem] font-semibold text-[#4f2030] shadow-[0_8px_14px_-14px_rgba(79,32,48,0.24)]"
        >
